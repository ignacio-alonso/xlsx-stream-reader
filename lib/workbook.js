...
// Sets up 'Tmp' to remove temporary files on process exit
      ...
      .on('entry', function (entry) {
        ...
        switch (entry.path) {
          ...
          case 'xl/_rels/workbook.xml.rels':
            ...
            break
          case '_rels/.rels':
             // If you do not intend to consume an entry stream's raw data, call autodrain() to dispose of the entry's contents
            entry.autodrain()
            break
          ...
          case 'xl/styles.xml':
            ...
            break
          default:
            // xl/worksheets contains the sheets
